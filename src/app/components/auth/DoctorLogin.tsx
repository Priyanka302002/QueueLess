...
import { ArrowLeft, Stethoscope, Lock, Mail, Shield, Globe } from "lucide-react";
    ...
    <div className="h-screen flex flex-col bg-[#FAFAFA] px-6 py-8 animate-fade-in">
      ...
      <div className="flex items-center justify-between mb-8 animate-fade-in-up" style={{ animationDelay: '100ms' }}>
        ...
        <div className="flex items-center gap-2">
          <div className="w-10 h-10 bg-gradient-to-br from-[#66BB6A] to-[#42A5F5] rounded-2xl flex items-center justify-center shadow-sm">
      ...
      <div className="mb-8 animate-fade-in-up" style={{ animationDelay: '200ms' }}>
        <div className="flex items-center gap-2 mb-2">
          <div className="w-12 h-12 bg-[#A5D6A7]/30 rounded-2xl flex items-center justify-center">
            <Stethoscope className="w-6 h-6 text-[#2E7D32]" strokeWidth={1.5} />
          </div>
          <h2 className="text-[#2E2E2E]">{t.doctorLogin}</h2>
        </div>
        <p className="text-[#757575] leading-relaxed">{t.enterDoctorID}</p>
      </div>
      ...
      <div className="flex-1 animate-fade-in-up" style={{ animationDelay: '300ms' }}>
        {/* Doctor ID Field */}
        <div className="mb-5">
          <label className="text-[#2E2E2E] mb-2 block">{t.doctorID}</label>
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-4 border border-[#E0E0E0] rounded-xl text-[#2E2E2E] placeholder:text-[#BDBDBD] focus:outline-none focus:border-[#2E7D32] focus:ring-2 focus:ring-[#A5D6A7]/30 transition-all duration-200"
            />
          </div>
        </div>
        ...
        <div className="mb-6">
          ...
          <button className="text-[#2E7D32] text-sm mt-2 hover:underline">
            {t.forgotPassword}
          </button>
        </div>
        ...
        <Button
          ...
          className={`w-full py-4 rounded-xl text-white shadow-md transition-all duration-200 ${
            !isFormValid() || isLoading
              ...
              : "bg-gradient-to-r from-[#66BB6A] to-[#42A5F5] hover:shadow-lg hover:scale-[1.02] active:scale-[0.98]"
          }`}
        >
